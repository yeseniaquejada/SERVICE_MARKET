...
EXEC VALIDAR_USUARIO 'valentina@gmail.com','a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3'
...
AS
SELECT N_IDENTIFICACION_USU, TIPO_DOC_USU, FECHA_NACIMIENTO_USU, FECHA_EXPEDICION_USU, NOMBRE_USU, APELLIDOS_USU, CELULAR_USU, CORREO_ELECTRONICO_USU, CONTRASENA_USU, GENERO_USU, ID_CIUDAD_FK, DIRECCION_USU
FROM USUARIOS 

/*CRUD VISTA*/
SELECT * FROM USUARIOS_V

INSERT INTO USUARIOS_V (N_IDENTIFICACION_USU, TIPO_DOC_USU, FECHA_NACIMIENTO_USU, FECHA_EXPEDICION_USU, NOMBRE_USU, APELLIDOS_USU, CELULAR_USU, CORREO_ELECTRONICO_USU, CONTRASENA_USU, GENERO_USU, ID_CIUDAD_FK, DIRECCION_USU) 
...
UPDATE USUARIOS_V SET TIPO_DOC_USU = 'CC',FECHA_NACIMIENTO_USU ='2022-01-01',FECHA_EXPEDICION_USU = '2022-01-01',NOMBRE_USU = 'PRUEBA',APELLIDOS_USU = 'PRUEBA2', CELULAR_USU = '1111', CORREO_ELECTRONICO_USU = 'PRUEBA@GMAIL.COM', CONTRASENA_USU = 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3',GENERO_USU = 'FEMENINO',ID_CIUDAD_FK = 1, DIRECCION_USU = 'CALLE 1' 
WHERE N_IDENTIFICACION_USU = '11111'

DELETE FROM USUARIOS_V WHERE N_IDENTIFICACION_USU = '11111'
...
/*VISTA TABLA ADMINISTRADORES*/
CREATE VIEW ADMINISTRADORES_V
AS
SELECT N_IDENTIFICACION_ADMIN, TIPO_DOC_ADMIN, FECHA_NACIMIENTO_ADMIN, FECHA_EXPEDICION_ADMIN, NOMBRE_ADMIN,APELLIDOS_ADMIN, CELULAR_ADMIN, CORREO_ELECTRONICO_ADMIN, CONTRASENA_ADMIN, GENERO_ADMIN
FROM ADMINISTRADORES 

/*CRUD VISTA*/
SELECT * FROM ADMINISTRADORES_V

INSERT INTO ADMINISTRADORES_V (N_IDENTIFICACION_ADMIN, TIPO_DOC_ADMIN, FECHA_NACIMIENTO_ADMIN, FECHA_EXPEDICION_ADMIN, NOMBRE_ADMIN,APELLIDOS_ADMIN, CELULAR_ADMIN, CORREO_ELECTRONICO_ADMIN, CONTRASENA_ADMIN, GENERO_ADMIN) VALUES ('11111','CC','2022-01-01','2022-01-01','PRUEBA','PRUEBA2','1111','PRUEBA@GMAIL.COM','a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3','FEMENINO')

UPDATE ADMINISTRADORES_V SET TIPO_DOC_ADMIN = 'CC', FECHA_NACIMIENTO_ADMIN ='2022-01-01', FECHA_EXPEDICION_ADMIN = '2022-01-01', NOMBRE_ADMIN = 'PRUEBA', APELLIDOS_ADMIN = 'PRUEBA2', CELULAR_ADMIN = '1111', CORREO_ELECTRONICO_ADMIN = 'PRUEBA@GMAIL.COM', CONTRASENA_ADMIN = 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3',GENERO_ADMIN = 'FEMENINO' WHERE N_IDENTIFICACION_ADMIN = '11111'

DELETE FROM ADMINISTRADORES_V WHERE N_IDENTIFICACION_ADMIN = '11111'
...
AS
SELECT ID_SERVICIO,NOMBRE_SER, PRECIO_SER, DESCRIPCION_BREVE,TERMINOS_SER, ESTADO_DS, TIPO, FECHA_PUBLICACION, N_IDENTIFICACION_USU_FK, N_IDENTIFICACION_ADMIN_FK, ID_CATEGORIA_FK 
FROM SERVICIOS

/*CRUD VISTA*/
SELECT * FROM SERVICIOS_V
INSERT INTO SERVICIOS_V(NOMBRE_SER,PRECIO_SER,DESCRIPCION_BREVE,TERMINOS_SER,TIPO,ID_CATEGORIA_FK)  VALUES ('Limpieza de casas',90000,'Solo se realiza aseo en areas comunes', 'No se plancha, ni cocina, no se cuidan adultos mayores.','Solicitud',2)
...
AS
SELECT ID_SERVICIO, NOMBRE_SER, PRECIO_SER, DESCRIPCION_BREVE, TERMINOS_SER, TIPO, N_IDENTIFICACION_USU_FK, 
NOMBRE_CAT, NOMBRE_USU, APELLIDOS_USU, CELULAR_USU, NOMBRE_CIUDAD
FROM
SERVICIOS INNER JOIN CATEGORIAS
ON SERVICIOS.ID_CATEGORIA_FK = CATEGORIAS.ID_CATEGORIA
INNER JOIN USUARIOS 
ON SERVICIOS.N_IDENTIFICACION_USU_FK = USUARIOS.N_IDENTIFICACION_USU
INNER JOIN CIUDAD
ON USUARIOS.ID_CIUDAD_FK = CIUDAD.ID_CIUDAD WHERE ESTADO_DS = 'Activo' AND TIPO = 'Publicacion' 
