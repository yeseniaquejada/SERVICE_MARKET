...
('REMODELACIÓN Y ALBAÑILERÍA','ORIENTADA EN LA CONSTRUCCION, RENOVACION Y REPARACION DE ESTRUCTURAS, PAREDES, MUROS, PARTES DE EDIFICIOS, CASAS Y MÁS.'),
...
AS 
BEGIN
	SELECT IMAGEN_SER, NOMBRE_SER, PRECIO_SER, TERMINOS_SER, NOMBRE_CAT FROM 
...
EXEC BUSQUEDAD_SERVICIOS 'YESENIA'
...
select * from  HISTORIAL_DETALLE_SERVICIOS
DELETE FROM SERVICIOS WHERE ID_SERVICIO = 1

insert into SERVICIOS VALUES ('MMMMM','LIMPIEZA',30000,'SOLO LIMPIEZA',2)