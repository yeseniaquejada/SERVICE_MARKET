...
/*INSERT TABLA ROLES*/
INSERT INTO ROLES(NOMBRE) VALUES ('ADMINISTRADOR'),('PRESTADOR DE SERVICIOS'),('CLIENTE')
...
BEGIN
	...
	BEGIN 
		INSERT INTO USUARIOS(N_IDENTIFICACION,TIPO_DOC,FECHA_NACIMIENTO,FECHA_EXPEDICION,NOMBRE,APELLIDOS,CELULAR,
		CORREO_ELECTRONICO,CONTRASENA,GENERO,CIUDAD,DIRECCION)
		VALUES (@N_IDENTIFICACION,@TIPO_DOC,@FECHA_NACIMIENTO,@FECHA_EXPEDICION,@NOMBRE,@APELLIDOS,@CELULAR,
		@CORREO_ELECTRONICO,@CONTRASENA,@GENERO,@CIUDAD,@DIRECCION)
		SET @REGISTRADO = 1
...
EXEC REGISTRAR_USUARIO '1013376602','CEDULA DE CIUDADANIA','2004-01-13','2022-02-14','YESENIA','QUEJADA ROJAS','3135293264','yeyerojas1308@gmail.com','a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3','FEMENINO','BELLO','CALLE 22 CARRERA 61 AA 51',@REGISTRADO OUTPUT,@MENSAJE OUTPUT
