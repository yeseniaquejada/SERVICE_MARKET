...
INSERT INTO CATEGORIAS(NOMBRE_CAT,DESCRIPCION_CAT) VALUES ('MANTENIMIENTO','MANTENIMIENTO PARA TUS EQUIPOS TECNOLOGICOS COMO LO SON LIMPIEZA, REPARACION ,GENERAL, PREVENTIVO, ETC.'),
('TRABAJOS DOMESTICOS','ASEO ESPECIALIZADO EN CONJUNTOS RESIDENCIALES, ÁREAS COMUNES, EMPRESAS, OFICINAS, LOCALES COMERCIALES, EDIFICIOS EMPRESARIALES, ESTABLECIMIENTOS DE INTERÉS SANITARIO (GIMNASIOS, IPS, CONSULTORIOS, VETERINARIAS, ENTRE OTROS) Y HOGARES'),
('REMODELACION','')

/*CREACION DE LA TABLA SERVICIOS*/
CREATE TABLE SERVICIOS(
ID_SERVICIO INT IDENTITY(1,1) PRIMARY KEY,
IMAGEN_SER VARCHAR(MAX) NOT NULL,
...
AS 
BEGIN
	INSERT INTO SERVICIOS(IMAGEN_SER,NOMBRE_SER,PRECIO_SER,TERMINOS_SER,ID_CATEGORIA_FK) 
	VALUES (@IMAGEN_SER,@NOMBRE_SER,@PRECIO_SER,@TERMINOS_SER,@ID_CATEGORIA_FK)
END
...
AS 
BEGIN
	SELECT IMAGEN_SER, NOMBRE_SER, PRECIO_SER, TERMINOS_SER, ID_CATEGORIA_FK FROM SERVICIOS
END

EXEC CONSULTAR_SERVICIOS

/*VISTA PUBLICACION DE SERVICIOS 
