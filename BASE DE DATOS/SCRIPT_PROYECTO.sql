...
UPDATE SERVICIOS_V SET N_IDENTIFICACION_USU_FK = '1001228354' WHERE ID_SERVICIO = 1
...
CREATE VIEW PUBLICACION_SERVICIOS_
AS
...
ON SERVICIOS.ID_CATEGORIA_FK = CATEGORIAS.ID_CATEGORIA WHERE ESTADO_DS = 'Activo' AND TIPO = 'Publicacion'
...
AS
BEGIN
	SELECT * FROM PUBLICACION_SERVICIOS_ WHERE ID_SERVICIO = @ID_SERVICIO
END
