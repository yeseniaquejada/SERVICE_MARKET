...
AS
SELECT N_IDENTIFICACION,TIPO_DOC,FECHA_NACIMIENTO,FECHA_EXPEDICION,NOMBRE_USU,APELLIDOS_USU,CELULAR_USU,
CORREO_ELECTRONICO, CONTRASENA, GENERO, ID_CIUDAD_FK, DIRECCION FROM USUARIOS 

/*CRUD VISTA*/
SELECT * FROM USUARIOS_V

INSERT INTO USUARIOS_V
(N_IDENTIFICACION,TIPO_DOC,FECHA_NACIMIENTO,FECHA_EXPEDICION,NOMBRE_USU,APELLIDOS_USU,CELULAR_USU,CORREO_ELECTRONICO, CONTRASENA, GENERO, ID_CIUDAD_FK, DIRECCION) 
VALUES 
('11111','CC','2022-01-01','2022-01-01','PRUEBA','PRUEBA2','1111','PRUEBA@GMAIL.COM','a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3','FEMENINO',1,'CALLE 1')

UPDATE USUARIOS_V SET 
TIPO_DOC = 'CC',FECHA_NACIMIENTO ='2022-01-01',FECHA_EXPEDICION = '2022-01-01',NOMBRE_USU = 'PRUEBA',APELLIDOS_USU = 'PRUEBA2', CELULAR_USU = '1111', CORREO_ELECTRONICO = 'PRUEBA@GMAIL.COM', CONTRASENA = 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3',GENERO = 'FEMENINO',ID_CIUDAD_FK = 1, DIRECCION = 'CALLE 1' 
...
AS
SELECT ID_SERVICIO,NOMBRE_SER, PRECIO_SER, DESCRIPCION_BREVE,TERMINOS_SER, ID_CATEGORIA_FK FROM SERVICIOS
